...
<template>
	<header
		class="bg-white grid grid-rows-1 max-h-screen fixed w-full top-0 z-10 overflow-hidden border-b border-gray-200">
		<nav
			...
			<div class="relative -left-3">
				<a :href="homepageUrl"
					...
					class="transition duration-500 trangray-x-0">
			...
			<div class="flex flex-row gap-2">
				<div class="flex flex-row items-center lg:gap-4 gap-2">
					...
					<select @change="changeSiteLanguage" v-model="selectedLanguage"
						class="border border-gray-300 rounded p-1 w-max">
